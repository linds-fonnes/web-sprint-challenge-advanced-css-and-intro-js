...
-Accessibility on a web page means that your web page is user friendly to anyone, wether that is someone who uses a screen reader or someone who has slow internet and can't render a lot going on on the web page.

2. Talk about 3 different things you can do to ensure your website is accessible.

-Use semantic HTML tags, use responsive design, avoid small font sizing (anything under 16px)

3. How would you explain the concept of a variable to someone new to programming?

-A variable is a set reference to something in the computer's memory. So when you assign something a value, you can then reuse that value in a logical way

4. What is the purpose of using functions in code?

-A function's purpose is so that you can simply invoke the function rather than rewriting the same desired results over and over.
