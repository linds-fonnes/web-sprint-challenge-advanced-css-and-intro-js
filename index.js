...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 4: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
Create a function called get20s() that takes data as an argument and returns an array with names of artists who were born in and died in 20th century (1900-2000) example ["Salvador Dali", "Frida Kahlo"]*/
// const centuryArtists = [];
...
function addArtist(array,id,name,years,genre,nationality,bio){
    array[array.length] = {id,name,years,genre,nationality,bio};
    return array;
  }
console.log(addArtist(artists,20,'Lindsey Fonnesbeck','1996-2020','Web Design','United Statesian','My bio is that I love to nap and that I love to eat. Oh yeahhhh.'));
